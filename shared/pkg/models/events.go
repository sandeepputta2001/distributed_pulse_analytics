...
type App struct {
	...
	CreatedAt           time.Time `json:"created_at" db:"created_at"`
	NotificationChannel string    `json:"notification_channel,omitempty" db:"notification_channel"`
...
type CohortDefinition struct {
	...
	LastComputedAt  *time.Time `json:"last_computed_at,omitempty" db:"last_computed_at"`
	CreatedAt       time.Time  `json:"created_at" db:"created_at"`
}
...
type NotificationDelivery struct {
	...
	Payload   AlertFiredEvent `json:"payload" bson:"payload"`
